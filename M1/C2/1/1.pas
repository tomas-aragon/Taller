...
a. Un modulo recursivo que retorne un vector de a lo sumo 15 nomeros enteros orandomo mayores a 10 y menores a 155 (incluidos ambos). La carga finaliza con 
el valor 20.
...
e. Un modulo recursivo que reciba el vector generado en a) y devuelva el moximo valor del vector.
...
g. Un modulo que reciba el vector generado en a) e imprima, para cada nomero contenido en el vector, sus dogitos en el orden en que aparecen en el nomero. 
Debe implementarse un modulo recursivo que reciba el nomero e imprima lo pedido. Ejemplo si se lee el valor 142, se debe imprimir 1  4  2
